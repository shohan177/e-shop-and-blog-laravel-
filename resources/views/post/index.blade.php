...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    ...
                    <a  class="btn btn-sm btn-primary shadow" id="add_new_post">ADD POST</a>
                </div>
        ...
        @endif
        @if (Session::has('info'))
            <input name= "mess[]" action="info" bold_mess ="Update" type="hidden" value="{{ Session::get('info') }}">
        @endif
                                        ...
                                        <td class="text-right">
                                            <div class="actions">
                                               ...
                                               @endif
                                                ...
                                                <a class="btn btn-sm bg-danger-light border-danger shadow" id="delete_post" d_post_id="{{ $d -> id }}" href="">
        ...
        <div class="row">
            <div id="edit_post"  class="col-sm-8 p-4 ml-3 shadow">
                <form action="{{ route('update_post') }}" method="POST" id="update_post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <input name="old_photo" style="display:none" type="text">
                                <input name="new_photo" style="display:none" type="file" id="update_photo">

                                <label  for="update_photo">Chose a image<img style="display: block; height:110px; width:150px ;cursor: pointer;" src="{{ asset('admin\media\default.png') }}" alt="" id="update_post_image_view" ></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="row ">
            <div id="add_post" class=" col-sm-8 p-4 ml-3 shadow">
                <form action="{{ route('post.store') }}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input id="up_photo" name="photo" style="display: none" type="file">
                    ...
                    <div class="form-group">
                        <textarea name="conatin" id="add_post_contain"></textarea>
                    </div>
